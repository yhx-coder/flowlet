...
from thrift_API.sswitch_runtime.ttypes import *
from thrift_API import thrift_API
from thrift_API.sswitch_runtime import SimpleSwitch
...
class SimpleSwitchThriftAPI(thrift_API.ThriftAPI):
    ...
    def __init__(self, thrift_port,
        ...
        super(SimpleSwitchThriftAPI,self).__init__(thrift_port,
                         thrift_ip,
                         pre_type, 
                         json_path)
